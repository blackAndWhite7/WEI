...
import com.wei.wei.classifyhelper.adapter.TravelingAdapter;
import com.wei.wei.classifyhelper.model.ChannelEntity;
import com.wei.wei.classifyhelper.model.FilterData;
import com.wei.wei.classifyhelper.model.FilterEntity;
import com.wei.wei.classifyhelper.model.FilterTwoEntity;
import com.wei.wei.classifyhelper.model.OperationEntity;
import com.wei.wei.classifyhelper.model.TravelingEntity;
import com.wei.wei.classifyhelper.util.ColorUtil;
import com.wei.wei.classifyhelper.util.DensityUtil;
import com.wei.wei.classifyhelper.util.ModelUtil;
import com.wei.wei.classifyhelper.util.StatusBarUtil;
import com.wei.wei.classifyhelper.view.FilterView;
import com.wei.wei.classifyhelper.view.HeaderBannerView;
import com.wei.wei.classifyhelper.view.HeaderChannelView;
import com.wei.wei.classifyhelper.view.HeaderDividerView;
import com.wei.wei.classifyhelper.view.HeaderFilterView;
import com.wei.wei.classifyhelper.view.HeaderOperationView;
import com.wei.wei.classifyhelper.view.SmoothListView.SmoothListView;
...
/**
 * Created by wei on 2018/2/7/00.
 * StickyHeaderListView
 */

public class ClassifyActivity extends AppCompatActivity implements SmoothListView.ISmoothListViewListener {
    ...
    @BindView(R.id.view_action_back_bg)
    View viewActionBackBg;
    @BindView(R.id.fl_action_more)
    FrameLayout flActionMore;
    @BindView(R.id.fl_action_back)
    FrameLayout flActionBack;
...
//                startActivity(new Intent(mActivity, AboutActivity.class));
        ...
        // 返回
        flActionBack.setOnClickListener(new View.OnClickListener() {
            @Override
