...
import com.wei.wei.upglidehelper.CommonFragment;
import com.wei.wei.upglidehelper.CustPagerTransformer;

import java.lang.reflect.Field;
import java.util.ArrayList;
import java.util.List;

public class UpglideActivity extends FragmentActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upglide);
    ...
    private void fillViewPager() {
        ...
        for (int i = 0; i < 5; i++) {
            // 预先准备10个fragment
            fragments.add(new CommonFragment(i));
        }
